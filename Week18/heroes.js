...
document.addEventListener("DOMContentLoaded", function(event){
    ...
    for (let hero of heroes){
        ...
        <div>Суперсила: ${hero.superpowers}</div></br>
        <div> <img src ='${hero.url}' alt='${hero.name}'> </img> </div></br>
        <div>Информация: ${hero.info}</div></br>
        
    <div class="ratings-wrapper">
	<div data-productid="i" class="ratings">
...
document.getElementById("heroesContainer").innerHTML = heroesList;
